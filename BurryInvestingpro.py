...
TECHNICAL_TTL_SECONDS = 900
YF_REQUEST_DELAY_SECONDS = 1.2
_yf_rate_limit_lock = Lock()
_yf_last_request_ts = 0.0

def yahoo_request_delay(delay_seconds: float = YF_REQUEST_DELAY_SECONDS) -> None:
...
# ==========================================
@st.cache_data(ttl=FUNDAMENTAL_TTL_SECONDS, show_spinner=False)
...
# ==========================================
@st.cache_data(ttl=TECHNICAL_TTL_SECONDS, show_spinner=False)
...
def setup_sidebar() -> Dict[str, Any]:
    ...
    refresh_cache_btn = st.sidebar.button("♻️ Svuota cache dati", use_container_width=True)
    if refresh_cache_btn:
        st.cache_data.clear()
        st.sidebar.success("Cache dati svuotata.")
